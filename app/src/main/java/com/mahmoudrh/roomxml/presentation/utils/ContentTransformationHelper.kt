...
sealed class ContentTransformationHelper(
    ...
    object UnderLined : ContentTransformationHelper(UNDER_LINED_REGEX, UNDER_LINED_SPAN_STYLE, UNDER_LINED_PREFIX, UNDER_LINED_SUFFIX)
    object Bold : ContentTransformationHelper(BOLD_REGEX, BOLD_SPAN_STYLE, BOLD_PREFIX, BOLD_SUFFIX)
    object Italic : ContentTransformationHelper(ITALIC_REGEX, ITALIC_SPAN_STYLE, ITALIC_PREFIX, ITALIC_SUFFIX)
